...
async function main() {
  ...
  const itemsMotor = [
    {
      sku: 'CAM-360-FRONT',
      descripcion: 'Cámara frontal 360º',
      familia: 'EQUIPOS',
      unidad: 'UD',
      precioBase: 195,
      costeBase: 120,
      metadatos: {
        rolArquitectura: 'Captura embarcada frontal',
        componentes: ['Sensor óptico gran angular', 'Módulo de compresión H.265', 'Interfaz M12 Ethernet'],
        prestaciones: ['Resolución HD para entorno urbano', 'Operación 24/7 en vibración', 'Integración con DVR embarcado'],
        normativa: [
          { grupo: 'UNECE', norma: 'R10', estado: 'CUMPLE', detalle: 'Compatibilidad electromagnética para vehículo' },
          { grupo: 'IP', norma: 'IP67', estado: 'CUMPLE', detalle: 'Protección frente a polvo y agua exterior' },
          { grupo: 'EMC', norma: 'EN 55032', estado: 'CUMPLE', detalle: 'Emisiones conducidas/radiadas dentro de límite' },
        ],
      },
    },
    {
      sku: 'CAM-360-LAT',
      descripcion: 'Cámara lateral/trasera 360º',
      familia: 'EQUIPOS',
      unidad: 'UD',
      precioBase: 165,
      costeBase: 98,
      metadatos: {
        rolArquitectura: 'Cobertura lateral y trasera',
        componentes: ['Óptica de alta apertura', 'Carcasa sellada antivandálica', 'Cableado blindado de señal'],
        prestaciones: ['Cobertura de ángulos muertos', 'Mejora seguridad en maniobras', 'Monitorización continua'],
        normativa: [
          { grupo: 'UNECE', norma: 'R10', estado: 'CUMPLE', detalle: 'Dispositivo embarcado homologable' },
          { grupo: 'IP', norma: 'IP67', estado: 'CUMPLE', detalle: 'Uso exterior en ciclo operativo intensivo' },
          { grupo: 'EMC', norma: 'EN 50121-3-2', estado: 'NO_APLICA', detalle: 'No aplica en este suministro urbano específico' },
        ],
      },
    },
    {
      sku: 'DVR-EMB-1TB',
      descripcion: 'DVR embarcado SSD 1TB',
      familia: 'EQUIPOS',
      unidad: 'UD',
      precioBase: 590,
      costeBase: 390,
      metadatos: {
        rolArquitectura: 'Núcleo de grabación y evidencias',
        componentes: ['CPU embebida industrial', 'SSD 1TB', 'Módulo comunicaciones y telemetría'],
        prestaciones: ['Grabación multicanal', 'Exportación segura de evidencias', 'Gestión remota de estado'],
        normativa: [
          { grupo: 'UNECE', norma: 'R10', estado: 'CUMPLE', detalle: 'Compatibilidad EMC vehículo' },
          { grupo: 'IP', norma: 'IP54', estado: 'CUMPLE', detalle: 'Montaje en compartimento protegido' },
          { grupo: 'EMC', norma: 'EN 55035', estado: 'CUMPLE', detalle: 'Inmunidad electromagnética validada' },
        ],
      },
    },
    {
      sku: 'MON-CAB-7',
      descripcion: 'Monitor cabina 7 pulgadas',
      familia: 'EQUIPOS',
      unidad: 'UD',
      precioBase: 210,
      costeBase: 125,
      metadatos: {
        rolArquitectura: 'Interfaz de operación en cabina',
        componentes: ['Panel TFT 7"', 'Control OSD', 'Interfaz vídeo/trigger'],
        prestaciones: ['Visualización de eventos', 'Asistencia de maniobra', 'Lectura en alta luminosidad'],
        normativa: [
          { grupo: 'UNECE', norma: 'R10', estado: 'CUMPLE', detalle: 'Equipo eléctrico embarcado' },
          { grupo: 'IP', norma: 'IP40', estado: 'CUMPLE', detalle: 'Instalación interior de cabina' },
          { grupo: 'EMC', norma: 'EN 55032', estado: 'CUMPLE', detalle: 'Emisión en límites para entorno móvil' },
        ],
      },
    },
    {
      sku: 'KIT-4G-GPS',
      descripcion: 'Kit conectividad 4G/WiFi/GPS con antena',
      familia: 'EQUIPOS',
      unidad: 'UD',
      precioBase: 320,
      costeBase: 210,
      metadatos: {
        rolArquitectura: 'Comunicaciones y geolocalización',
        componentes: ['Módem LTE', 'Antena multibanda', 'Receptor GNSS'],
        prestaciones: ['Conectividad en tiempo real', 'Trazabilidad geográfica', 'Canal de diagnóstico remoto'],
        normativa: [
          { grupo: 'UNECE', norma: 'R10', estado: 'CUMPLE', detalle: 'Compatibilidad para sistemas radioeléctricos embarcados' },
          { grupo: 'IP', norma: 'IP65', estado: 'CUMPLE', detalle: 'Conjunto de antena en exterior de vehículo' },
          { grupo: 'EMC', norma: 'ETSI EN 301 489', estado: 'CUMPLE', detalle: 'Compatibilidad electromagnética equipos radio' },
        ],
      },
    },
  ...
  for (const item of itemsMotor) {
    await prisma.itemCatalogo.upsert({
      ...
      update: {
        ...
        metadatos: (item as any).metadatos ?? undefined,
        activo: true,
      },
      create: {
        ...item,
